<%-- 
    ...
    Created on : Jan 3, 2017, 7:32:12 PM
    Author     : Toan
--%>
                        ...
                        <div class="row ">
                            <div class="col-xs-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active breadcrumb-title">Cập nhật thông tin</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-12">
                                <div id="login" class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 form-style form-login">
                                    <form accept-charset='UTF-8' action="UserServlet" method="POST">
                                        ...
                                        <input type="hidden" value="update" name="command" id="command"/>
                                        ...
                                        <div class="row info-input">
                                            <div class="">
                                                <ul>
                                                    <li><a class="hover_underline" href="./change_pass.jsp">Đổi mật khẩu</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <button class="btn-cart btn btn-primary pull-left" type="submit">Thay đổi</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
