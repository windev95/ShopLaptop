<%-- 
    Document   : head
    Created on : Nov 27, 2016, 7:48:00 PM
    Author     : BoyIt
--%>
...
<!--    <script src='//bizweb.dktcdn.net/100/052/640/themes/134620/assets/modernizr-2.8.3.min.js?1479951271873' type='text/javascript'></script>
	...
	<script>var ProductReviewsAppUtil=ProductReviewsAppUtil || {};</script>
        ...
        <noscript><iframe height='0' width='0' style='display:none;visibility:hidden' src='/visit/record.gif?p=%2f&r=https%3a%2f%2fthemes.bizweb.vn%2fdemo%2franger-theme&s=kziavtlrckcynsryriu4msmu'></iframe></noscript>
        <script>
            (function () {
                function asyncLoad() {
                    var urls = [];
