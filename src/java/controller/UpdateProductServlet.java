...
public class UpdateProductServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao.update(new Product(Long.parseLong(campos.get(0)),campos.get(1), imgs.get(0), campos.get(2), campos.get(3), campos.get(4), campos.get(5), campos.get(6), campos.get(7), campos.get(8), campos.get(9), campos.get(10), campos.get(11), campos.get(12), campos.get(13), campos.get(14), campos.get(15), campos.get(16), campos.get(17), campos.get(18), campos.get(19), campos.get(20), campos.get(21), campos.get(22),Integer.parseInt(campos.get(23)), Integer.parseInt(campos.get(24)), Integer.parseInt(campos.get(25)), timestamp, Integer.parseInt(campos.get(26)), Integer.parseInt(campos.get(27)), Long.parseLong(campos.get(28)), Long.parseLong(campos.get(29)), Long.parseLong(campos.get(30)), Long.parseLong(campos.get(31)), Long.parseLong(campos.get(32)), Long.parseLong(campos.get(33)), Long.parseLong(campos.get(34))));
        } catch (Exception e) {
        }
