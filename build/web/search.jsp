<%-- 
    Document   : search
    Created on : Dec 29, 2016, 7:06:05 PM
    Author     : Toan
--%>
...
<html>
    ...
    <body>
        <%
            ...
            total = productDAO.countProductBySearch(query);
            if (total <= pagesize) {
                firstResult = 0;
                maxResult = total;
            }else{
             ...
             ArrayList<Product> listProduct = productDAO.getListProductBySearchNav(query, firstResult, maxResult);
        %>
        <div id="page-wrapper">
                                            ...
                                            <div class="filter-right">
                                                <div class="collection-pagination pull-right pagination-wrapper">
                                                    <ul class="pagination">                                                                                          
                                                        ...
                                                        <li><a href="search.jsp?query=<%=query%>&pages=<%=i%>"><%=i%></a></li>
                                                        <%}%>
                                                    </ul>
                                                </div>
                                            </div>
