...
<html>
    <head>
        ...
        <!-- Bootstrap -->
        <link href="${root}/Admin/css/jquery.dataTables.min.css" rel="stylesheet"> 
        <script src="${root}/Admin/js/jquery-1.12.4.js"></script>        
        <script src="${root}/Admin/js/jquery.dataTables.min.js"></script>
