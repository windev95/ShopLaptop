                            ...
                            <div>
                                <div class="tablist_parent col-md-12">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Bàn Cafe</a></li>
                                        <li role="presentation"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab">Ghế Cafe</a></li>
                                        <li role="presentation"><a href="#settings" aria-controls="settings" role="tab" data-toggle="tab">Sofa Hàn quốc</a></li>
                                        <li role="presentation"><a href="#settings2" aria-controls="settings2" role="tab" data-toggle="tab">Sofa cao cấp</a></li>
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane active" id="home">
                                        <div class="featured_projects_hidden_xs">
                                            <div class="col-sm-6 col-md-4 projects-item-content">
                                                <div class="projects-item">
                                                    <a href="./detail.jsp"><img src="./images/product/lenovo-ideapad-100.png" alt="Ghế Sofa đơn"></a>
                                                    <div class="projects-item-info">
                                                        <h3 class="projects-item-title"><a href="/ghe-sopha-kem">Ghế Sofa đơn</a></h3>
                                                        <p class="projects-item-description"><a href="/ghe-sopha-kem">2.560.000₫</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-4 projects-item-content">
                                                <div class="projects-item">
                                                    <a href="./detail.jsp"><img src="./images/product/lenovo-ideapad-100.png" alt="Sofa cổ điển"></a>
                                                    <div class="projects-item-info">
                                                        <h3 class="projects-item-title"><a href="/sopha-giuong-co-dien">Sofa cổ điển</a></h3>
                                                        <p class="projects-item-description"><a href="/sopha-giuong-co-dien">12.540.000₫</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-4 projects-item-content">
                                                <div class="projects-item">
                                                    <a href="./detail.jsp"><img src="./images/product/lenovo-ideapad-100.png" alt="Sofa đơn SFD18"></a>
                                                    <div class="projects-item-info">
                                                        <h3 class="projects-item-title"><a href="/sofa-don-sfd18">Sofa đơn SFD18</a></h3>
                                                        <p class="projects-item-description"><a href="/sofa-don-sfd18">5.100.000₫</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-4 projects-item-content">
                                                <div class="projects-item">
                                                    <a href="./detail.jsp"><img src="./images/product/lenovo-ideapad-100.png" alt="Sofa đẹp hiện đại"></a>
                                                    <div class="projects-item-info">
                                                        <h3 class="projects-item-title"><a href="/sopha-giuong-dep-hien-dai">Sofa đẹp hiện đại</a></h3>
                                                        <p class="projects-item-description"><a href="/sopha-giuong-dep-hien-dai">16.890.000₫</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-4 projects-item-content">
                                                <div class="projects-item">
                                                    <a href="./detail.jsp"><img src="./images/product/lenovo-ideapad-100.png" alt="Bộ sofa ph&#242;ng kh&#225;ch m&#224;u ghi"></a>
                                                    <div class="projects-item-info">
                                                        <h3 class="projects-item-title"><a href="/bo-sofa-phong-khach-mau-ghi">Bộ sofa phòng khách màu ghi</a></h3>
                                                        <p class="projects-item-description"><a href="/bo-sofa-phong-khach-mau-ghi">14.755.789₫</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-md-4 projects-item-content">
                                                <div class="projects-item">
                                                    <a href="./detail.jsp"><img src="./images/product/lenovo-ideapad-100.png" alt="Sofa d&#224;i hiện đại"></a>
                                                    <div class="projects-item-info">
                                                        <h3 class="projects-item-title"><a href="/sopha-dai-hien-dai">Sofa dài hiện đại</a></h3>
                                                        <p class="projects-item-description"><a href="/sopha-dai-hien-dai">8.550.000₫</a></p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12 text-center projects-item-content">
                                            <a href="/collections/frontpage" class="projects-item-content-more btn btn-default">Xem thêm</a>
                                        </div>
                                    </div>
                                            ...
                                            <form action="/cart/add" class="product_item_form" method="post">
                                                ...
                                                <div class="product-gird">
                                                    <div class="product-img-parent">
                                                        ...
                                                        <a class="product-img" href="/ban-trang-tri" title="Bàn trang trí">
                                                            <img class="product-img-first" src="./images/product/lenovo-ideapad-100.png" alt="B&#224;n trang tr&#237;">
                                                        </a>
                                                        <div class="product-action-btn">
                                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                                <a class="btn btn-default btn-lg addtocart" href="/ban-trang-tri">CHỌN SẢN PHẨM</a>
                                                                <a href="/ban-trang-tri" class="btn btn-default btn-black btn-lg">CHI TIẾT</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <span class="product-price text-center">
                                                        <b class="productminprice">760.000₫</b>
                                                        <del>800.000₫</del>
                                                    </span>
                                                    <h3 class="product-name"><a href="/ban-trang-tri" title="Bàn trang trí">Bàn trang trí</a></h3>
                                                    <div style="display:none">
                                                        <select id="product-selectors" name="variantId" style="display:none">
                                                            <option lỗi liquid unknown operator roduct value="2023875">Đỏ - 760.000₫</option>
                                                            <option lỗi liquid unknown operator roduct value="2023876">Trắng - 760.000₫</option>
                                                        </select>
                                                    </div>
                                                    <!--số lượng-->
                                                    <div style="display:none">
